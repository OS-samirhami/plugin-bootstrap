...
@Plugin(service=ServiceNameConstants.OptionValues,name="example-option")
@PluginDescription(title="Example Option", description="My Option plugin description")
public class ExampleOption implements OptionValuesPlugin, Describable{

    public static final String SERVICE_PROVIDER_NAME = "example-option";
