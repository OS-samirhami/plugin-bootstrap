package com.plugin.examplenotification;
...
@Plugin(service="Notification", name="example-notification")
@PluginDescription(title="Example Notification", description="This is a notification plugin that integrated with Example Notification.")
public class ExampleNotification implements NotificationPlugin, AcceptsServices {

    static Logger logger = LoggerFactory.getLogger(ExampleNotification.class);
