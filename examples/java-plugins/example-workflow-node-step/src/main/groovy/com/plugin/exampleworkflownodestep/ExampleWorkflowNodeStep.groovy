package com.plugin.exampleworkflownodestep;
...
class ExampleWorkflowNodeStep implements NodeStepPlugin {
    /**
     * Define a name used to identify your plugin. It is a good idea to use a fully qualified package-style name.
     */
    public static final String PLUGIN_NAME = "example-workflow-node-step"
    public static final String PLUGIN_TITLE = "Example Workflow Node Step"
    public static final String PLUGIN_DESCRIPTION = "Template Node Step plugin that makes a call to an API and retrieves a response."
    ...
    @PluginProperty(
        title = "API URL",
        description = """Provide the base URL for the API to connect to. It will be used by the plugin to get information from the API. If left blank, the call will use a default base API URL.
...
Want to learn more about the Rundeck API? Check out [our docs](https://docs.rundeck.com/docs/api/rundeck-api.html).""",
    ...
    */
    ...
    @PluginProperty(
        ...
        description = """This is another test property to be output at the end of the execution.By default, it will be collapsed in the list of properties, thanks to the '@RenderingOption' 'GROUPING' key being set to 'secondary'.""",
        required = false
    )
    ...
    void executeNodeStep(final PluginStepContext context,
        ...
        */
        ...
        logger.log(3, "Here is a single line log entry. We'll print this as a logLevel 2, along with our next log lines.")
        logger.log(3, "Plugins use configurable logging levels that determines when a log is generated. Here's how it works:")
        ...
        */
        ...
        def Json = JsonOutput.toJson(resourceInfo)
