...
@Plugin(name = ExampleResourceModelSourceFactory.PLUGIN_NAME, service=ServiceNameConstants.ResourceModelSource)
@PluginDescription(title = ExampleResourceModelSourceFactory.PLUGIN_TITLE, description = ExampleResourceModelSourceFactory.PLUGIN_DESCRIPTION)
public class ExampleResourceModelSourceFactory implements ResourceModelSourceFactory {

    public static final String PLUGIN_NAME = "example-resource-model-source"
    public static final String PLUGIN_TITLE = "Example Resource Model Source"
    ...
    ResourceModelSource createResourceModelSource(Services services, Properties properties) throws ConfigurationException {
        ...
        def resource = new ExampleResourceModelSource(properties, services)
        return resource;
    }
