package com.plugin.examplenodeexecutor;
...
@Plugin(name = "example-node-executor", service = ServiceNameConstants.NodeExecutor)
@PluginDescription(title = "Example Node Executor", description = "A node executor plugin that can execute commands on remote nodes")
public class ExampleNodeExecutor implements NodeExecutor, Describable {

    public static final String SERVICE_PROVIDER_NAME = "example-node-executor"
