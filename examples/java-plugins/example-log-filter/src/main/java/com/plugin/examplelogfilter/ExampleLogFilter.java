package com.plugin.examplelogfilter;
...
@Plugin(service="LogFilter",name="example-log-filter")
@PluginDescription(title="Example Log Filter", description="My plugin description")
